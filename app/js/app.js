...
/***/ function(module, exports, __webpack_require__) {
	...
	var _taskmanagerTaskStore = __webpack_require__(160);

	var _taskmanagerTaskStore2 = _interopRequireDefault(_taskmanagerTaskStore);

	var _taskmanagerTaskActions = __webpack_require__(173);

	var _taskmanagerTaskActions2 = _interopRequireDefault(_taskmanagerTaskActions);
	...
	var App = (function (_Component) {
	  ...
	  function App() {
	    ...
	    _taskmanagerTaskActions2['default'].createTask();
	    this.state = {
	      tasks: _taskmanagerTaskStore2['default'].getState()
	    };
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.storeSubscription = _taskmanagerTaskStore2['default'].addListener(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appdispatcher = __webpack_require__(168);
	...
	TaskStore.dispatchToken = _appdispatcher2['default'].register(function (action) {
	  switch (action.type) {
